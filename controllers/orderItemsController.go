	...
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError,
				gin.H{"error": "Erro while listing order items "})
			return
		}
...
func GetOrderItemsByOrder() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError,
				gin.H{"error": "error occured whoile listing order items by id"})
			return
		}
		c.JSON(http.StatusOK, allOrderItems)
	}
...
func GetOrderItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err := orderItemCollection.FindOne(ctx,
			bson.M{"orderItem_id": orderItemId}).Decode(&orderItem)
		defer cancel()
		if err != nil {
...
func CreateOrderItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		order.Order_id = *OrderItemPack.Table_id
		...
		insertedOrdertems, err := orderItemCollection.InsertMany(ctx, orderItemsToBeInserted)
		if err != nil {
			log.Fatal(err)
		}
		defer cancel()
		c.JSON(http.StatusOK, insertedOrdertems)
...
func UpdateOrderItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError,
				gin.H{"error": "Error updating Order item"})
			return
		}
		defer cancel()
